...
# Configuration
#                                # Example
workdir=/raid/raid9/bockjoo/bockjoo/CMS_Site_IO/SitePerform/HammerCloudXrootdMonitoring              # $HOME/T2/ops/ftools/ftool-check-hammercloud
notifytowhom=bockjoo@phys.ufl.edu    # somebody@if.somewhere.edu
thesite=T2_US_Florida              # T2_US_Florida
# Configuration
